...
class SibenchSpec:
    ...
    def __init__(self, port, servers, bandwidth, worker_factor, skip_read_verification, generator, slice_dir, slice_count, slice_size, script):
        self.port = port
    ...
    def flatten(self):
        ...
        for b in self.bandwidth.split(','):
            for w in self.worker_factor.split(','):
                results.append(SibenchSpec(self.port, 
                                           self.servers, 
                                           b, 
                                           w, 
                                           self.skip_read_verification, 
                                           self.generator, 
                                           self.slice_dir, 
                                           self.slice_count, 
                                           self.slice_size,
